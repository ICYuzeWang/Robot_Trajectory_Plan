...
%     Point_position_matrix(:, 1) = T_k_1;
    Point_position_matrix(:, count_qvp) = [0;0;0];
...
writerObj = VideoWriter('.\figure\task4_simulation_forward.avi');
...
saveas(a,'.\figure\task4_simulation_forward_angle.png')
%%
a = figure;
...
saveas(a,'.\figure\task4_simulation_forward_angle_velocity.png')

%%
a = figure;
plot3(Point_position_matrix(1, 2:end), Point_position_matrix(2, 2:end), Point_position_matrix(3, 2:end));
saveas(a,'.\figure\task4_simulation_forward_trajectory.png')
...
saveas(a,'.\figure\task4_simulation_forward_linear_velocity.png')
% % Plot of joint velocities during motion
% subplot(3,1,1)
