...
step4_position = [3.14159 2.13643 0.51605 1.27645 1.57080 1.57080]./pi.*180;
...
% create the video writer with 1 fps
writerObj = VideoWriter('.\figure\task3_DH6_real.avi');
writerObj.FrameRate = 10;
% set the seconds per image
% open the video writer
open(writerObj);
...
saveas(a,'.\figure\Task3_DH6_real_angle.png')
%%
a = figure;
...
saveas(a,'.\figure\Task3_DH6_real_angle_velocity.png')
%%
a = figure;
plot3(Point_position_matrix(1, :), Point_position_matrix(2, :), Point_position_matrix(3, :));
saveas(a,'.\figure\Task3_DH6_real_trajectory.png')
...
saveas(a,'.\figure\Task3_DH6_real_linear_velocity.png')
% % Plot of joint velocities during motion
% subplot(3,1,1)
