...
targets_list = [90 90 90 90 90 90]';
...
targets_list(:,11) = [90 90 90 90 90 90]';
...
% create the video writer with 1 fps
writerObj = VideoWriter('.\figure\task5_simulation.avi');
writerObj.FrameRate = 10;
% set the seconds per image
% open the video writer
open(writerObj);
...
saveas(a,'.\figure\task5_simulation_angle.png')
%%
a = figure;
...
saveas(a,'.\figure\task5_simulation_angle_velocity.png')

%%
a = figure;
plot3(Point_position_matrix(1, 2:end), Point_position_matrix(2, 2:end), Point_position_matrix(3, 2:end));
saveas(a,'.\figure\task5_simulation_trajectory.png')
...
saveas(a,'.\figure\task5_simulation_linear_velocity.png')
% % Plot of joint velocities during motion
% subplot(3,1,1)
